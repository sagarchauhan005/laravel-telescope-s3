...
class TelescopeServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton(
            \Laravel\Telescope\Contracts\EntriesRepository::class, \Laravel\Telescope\Storage\S3EntriesRepository::class
        );
        $this->app->singleton(
            \Laravel\Telescope\Contracts\ClearableRepository::class, \Laravel\Telescope\Storage\S3EntriesRepository::class
        );
        $this->app->singleton(
            \Laravel\Telescope\Contracts\PrunableRepository::class, \Laravel\Telescope\Storage\S3EntriesRepository::class
        );
        $this->app->when(\Laravel\Telescope\Storage\S3EntriesRepository::class)
            ->needs('$disk')
            ->give(config('telescope.storage.s3.disk'));
        $this->app->when(\Laravel\Telescope\Storage\S3EntriesRepository::class)
            ->needs('$directory')
            ->give(config('telescope.storage.s3.directory'));
    }
}
